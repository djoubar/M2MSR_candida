...
predictors <- setdiff(names(df_stepwise), c("resultat_candida_def", "iep", "deces_rea"))
...
# mod_backward <- readRDS("models/mod_brutes_backward.rds")
...
# mod_forward <- readRDS("models/mod_brutes_forward.rds")
tbl3_fwd <- tbl_regression(mod_forward, exponentiate = TRUE)
# # AUC
...
saveRDS(model_forward, "models/mod_forward_2705.rds")
